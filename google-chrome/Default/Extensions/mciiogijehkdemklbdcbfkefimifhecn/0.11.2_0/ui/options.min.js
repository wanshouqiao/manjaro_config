...
(function(e){e.extend(!0,window,{Slick:{Grid:function(r,n,h,d){function y(){za||(za=!0,ma=parseFloat(e.css(aa[0],"width",!0)),D(),u(ca),d.enableTextSelectionOnCells||ea.bind("selectstart.ui",function(a){return e(a.target).is("input,textarea")}),Ob(),N(),K(),H(),Fa(),z(),aa.bind("resize.slickgrid",Fa),ea.bind("scroll",fb),Wa.bind("contextmenu",Tc).bind("click",Uc).delegate(".slick-header-column","mouseenter",Vc).delegate(".slick-header-column","mouseleave",Wc),Aa.bind("scroll",Xc),ub.add(Pb).bind("keydown",
jc).bind("focusin",function(){aa.addClass("is-focused")}).bind("focusout",function(){aa.removeClass("is-focused")}),ja.bind("keydown",jc).bind("click",Yc).bind("dblclick",Zc).bind("contextmenu",$c).bind("draginit",ad).bind("dragstart",{distance:3},bd).bind("drag",cd).bind("dragend",dd).delegate(".slick-cell","mouseenter",ed).delegate(".slick-cell","mouseleave",fd),navigator.userAgent.toLowerCase().match(/webkit/)&&navigator.userAgent.toLowerCase().match(/macintosh/)&&ja.bind("mousewheel",gd))}function F(a){for(var b=
Ia.length;0<=b;b--)if(Ia[b]===a){Ia[b].destroy&&Ia[b].destroy();Ia.splice(b,1);break}}function S(){for(var a=0,b=0,c=h.length;b<c;b++)a+=h[b].width;a+=f.width;return Math.max(a,ma)+1E3}function T(){for(var a=Ga?ma-f.width:ma,b=0,c=h.length;c--;)b+=h[c].width;return d.fullWidthRows?Math.max(b,a):b}function I(a){var b=Ba;Ba=T();Ba!=b&&(ja.width(Ba),Na.width(Ba),ca.width(S()));Qb=Ba>ma-(Ga?f.width:0);kc.width(Ba+(Ga?f.width:0));(Ba!=b||a)&&Xa()}function u(a){a&&a.jquery&&a.attr("unselectable","on").css("MozUserSelect",
"none").bind("selectstart.ui",function(){return!1})}function z(){for(var a=ja[0];(a=a.parentNode)!=document.body&&null!=a;)if(a==ea[0]||a.scrollWidth!=a.clientWidth||a.scrollHeight!=a.clientHeight){var b=e(a);Oa?Oa=Oa.add(b):Oa=b;b.bind("scroll."+na,lc)}}function N(){function a(){e(this).addClass("ui-state-hover")}function b(){e(this).removeClass("ui-state-hover")}ca.find(".slick-header-column").each(function(){var x=e(this).data("column");x&&w(G.H,{node:this,column:x})});ca.empty();ca.width(S());
...
null!=c&&b.eq(c).addClass("slick-header-column-sorted").find(".slick-sort-indicator").addClass(m.sortAsc?"slick-sort-indicator-asc":"slick-sort-indicator-desc")})}function oc(a,b){Vb=[];for(var c={},m=0;m<b.length;m++)for(var v=b[m].fromRow;v<=b[m].toRow;v++){c[v]||(Vb.push(v),c[v]={});for(var x=b[m].fromCell;x<=b[m].toCell;x++)pc(v,x)&&(c[v][h[x].id]=d.selectedCellCssClass)}qc(d.selectedCellCssClass,c);w(G.onSelectedRowsChanged,{rows:wb()},a)}function Ob(){Ya=[];Za=[];for(var a=0,b=0,c=h.length;b<
c;b++)Ya[b]=a,Za[b]=a+h[b].width,a+=h[b].width}function mc(a){h=a;pa={};for(a=0;a<h.length;a++){var b=h[a]=e.extend({},Wb,h[a]);pa[b.id]=a;b.minWidth&&b.width<b.minWidth&&(b.width=b.minWidth);b.maxWidth&&b.width>b.maxWidth&&(b.width=b.maxWidth)}Ob();za&&(Qa(),N(),Ra.remove(),Sa=null,H(),Fa(),Xa(),fb())}function qa(){return n.getLength?n.getLength():n.length}function Ka(){return qa()+(d.enableAddRow?1:0)}function Ca(a){return n.getItem?n.getItem(a):n[a]}function xb(a){return Math.floor((a+ha)/d.rowHeight)}
function La(a){a=Math.max(a,0);a=Math.min(a,wa-ba+(Qb?f.height:0));var b=ha;hb=Math.min(ib-1,Math.floor(a/jb));ha=Math.round(hb*yb);a-=ha;if(ha!=b){var c=kb(a);rc(c);for(var m in Q)Q[m].f.style.top=d.rowHeight*m-ha+"px"}$a!=a&&(ab=$a+b<a+ha?1:-1,ea[0].scrollTop=zb=da=$a=a,w(G.onViewportChanged,{}))}function Ab(a,b){var c=(a=n.getItemMetadata&&n.getItemMetadata(a))&&a.c&&(a.c[b.id]||a.c[pa[b.id]]);return c&&c.formatter||a&&a.formatter||b.formatter||d.formatterFactory&&d.formatterFactory.ha(b)||d.defaultFormatter}
function sc(a,b){var c=h[b];return(a=(a=n.getItemMetadata&&n.getItemMetadata(a))&&a.c)&&a[c.id]&&void 0!==a[c.id].editor?a[c.id].editor:a&&a[b]&&void 0!==a[b].editor?a[b].editor:c.editor||d.editorFactory&&d.editorFactory.ga(c)}function Bb(a,b){return d.dataItemColumnValueExtractor?d.dataItemColumnValueExtractor(a,b):a[b.field]}function tc(a,b,c,m,v){var x=h[c],A="slick-cell l"+c+" r"+Math.min(h.length-1,c+m-1)+(x.cssClass?" "+x.cssClass:"");b===M&&c===Z&&(A+=" active");for(var J in ta)ta[J][b]&&ta[J][b][x.id]&&
(A+=" "+ta[J][b][x.id]);a.push("<div class='"+A+"'>");v&&(A=Bb(v,x),a.push(Ab(b,x)(b,c,A,x,v)));a.push("</div>");Q[b].A.push(c);Q[b].B[c]=m}function rc(a){for(var b in Q)(b=parseInt(b,10))!==M&&(b<a.top||b>a.bottom)&&Cb(b)}function Qa(){O&&Da();lb();for(var a in Q)Cb(a)}function Cb(a){var b=Q[a];b&&(Db==b.f?(b.f.style.display="none",mb=Db):ja[0].removeChild(b.f),delete Q[a],delete Ma[a],uc--,hd++)}function vc(a){var b;if(a&&a.length){var c=ab=0;for(b=a.length;c<b;c++)O&&M===a[c]&&Da(),lb(),Q[a[c]]&&
Cb(a[c])}}function wc(a){vc([a])}function Xb(a){var b=Q[a];if(b){nb(a);var c=Ca(a),m;for(m in b.b)if(b.b.hasOwnProperty(m)){m|=0;var v=h[m],x=b.b[m];a===M&&m===Z&&O?O.i(c):c?x.innerHTML=Ab(a,v)(a,m,Bb(c,v),v,c):x.innerHTML=""}Yb(a)}}function Fa(){za&&(d.autoHeight?ba=d.rowHeight*Ka():ba=parseFloat(e.css(aa[0],"height",!0))-parseFloat(e.css(aa[0],"paddingTop",!0))-parseFloat(e.css(aa[0],"paddingBottom",!0))-parseFloat(e.css(Wa[0],"height"))-B(Wa)-(d.showTopPanel?d.topPanelHeight+B(ob):0)-(d.showHeaderRow?
...
1,yb=0):(xa=q,jb=xa/100,ib=Math.floor(wa/jb),yb=(wa-xa)/(ib-1));xa!==A&&(ja.css("height",xa),da=ea[0].scrollTop);b=da+ha<=wa-ba;0==wa||0==da?hb=ha=0:b?La(da+ha):La(wa-ba);xa!=A&&d.autoHeight&&Fa();d.forceFitColumns&&c!=Ga&&fa();I(!1)}}function kb(a,b){null==a&&(a=da);null==b&&(b=ra);return{top:xb(a),bottom:xb(a+ba)+1,o:b,u:b+ma}}function xc(a,b){a=kb(a,b);b=Math.round(ba/d.rowHeight);-1==ab?(a.top-=b,a.bottom+=3):1==ab?(a.top-=3,a.bottom+=b):(a.top-=3,a.bottom+=3);a.top=Math.max(0,a.top);a.bottom=
Math.min(Ka()-1,a.bottom);a.o-=ma;a.u+=ma;a.o=Math.max(0,a.o);a.u=Math.min(Ba,a.u);return a}function nb(a){if((a=Q[a])&&a.A.length)for(var b=a.f.lastChild;a.A.length;){var c=a.A.pop();a.b[c]=b;b=b.previousSibling}}function yc(){d.enableAsyncPostRender&&(clearTimeout($b),$b=setTimeout(zc,d.asyncPostRenderDelay))}function Yb(a){delete Ma[a];qb=Math.min(qb,a);rb=Math.max(rb,a);yc()}function la(){if(za&&!ac){var a=kb(),b=xc();rc(b);if(pb!=ra){for(var c,m=[],v=[],x,A,J=b.top,L=b.bottom;J<=L;J++)if(c=Q[J]){nb(J);
var P=void 0;A=b;x=J;var W=0,X=Q[x],E=[];for(P in X.b)if(X.b.hasOwnProperty(P)){P|=0;var ia=X.B[P];(Ya[P]>A.u||Za[Math.min(h.length-1,P+ia-1)]<A.o)&&(x!=M||P!=Z)&&E.push(P)}for(;null!=(P=E.pop());)X.f.removeChild(X.b[P]),delete X.B[P],delete X.b[P],Ma[x]&&delete Ma[x][P],W++;x=0;W=(W=n.getItemMetadata&&n.getItemMetadata(J))&&W.c;X=Ca(J);E=0;for(P=h.length;E<P&&!(Ya[E]>b.u);E++)null==(A=c.B[E])&&(A=1,W&&(A=(A=W[h[E].id]||W[E])&&A.G||1,"*"===A&&(A=P-E)),Za[Math.min(P-1,E+A-1)]>b.o&&(tc(m,J,E,A,X),x++)),
E+=1<A?A-1:0;x&&v.push(J)}if(m.length)for(J=document.createElement("div"),J.innerHTML=m.join("");null!=(c=v.pop());)for(c=Q[c];null!=(L=c.A.pop());)m=J.lastChild,c.f.appendChild(m),c.b[L]=m}v=ja[0];c=[];m=[];J=!1;W=qa();L=b.top;for(x=b.bottom;L<=x;L++)if(!Q[L]){uc++;m.push(L);Q[L]={f:null,B:[],b:[],A:[]};X=c;E=L;P=b;ia=W;A=Ca(E);var ka="slick-row"+(E<ia&&!A?" loading":"")+(E===M?" active":"")+(1==E%2?" odd":" even");A||(ka+=" "+d.addNewRowCssClass);(ia=n.getItemMetadata&&n.getItemMetadata(E))&&ia.M&&
(ka+=" "+ia.M);X.push("<div class='ui-widget-content "+ka+"' style='top:"+(d.rowHeight*E-ha)+"px'>");ka=0;for(var gb=h.length;ka<gb;ka++){var bc=h[ka];var Ta=1;ia&&ia.c&&(Ta=(bc=ia.c[bc.id]||ia.c[ka])&&bc.G||1,"*"===Ta&&(Ta=gb-ka));if(Za[Math.min(gb-1,ka+Ta-1)]>P.o){if(Ya[ka]>P.u)break;tc(X,E,ka,Ta,A)}1<Ta&&(ka+=Ta-1)}X.push("</div>");V&&M===L&&(J=!0);id++}if(m.length){b=document.createElement("div");b.innerHTML=c.join("");L=0;for(x=m.length;L<x;L++)Q[m[L]].f=v.appendChild(b.firstChild);J&&(V=ua(M,
Z))}qb=a.top;rb=Math.min(Ka()-1,a.bottom);yc();zb=da;pb=ra;Fb=null}}function Xc(){var a=Aa[0].scrollLeft;a!=ea[0].scrollLeft&&(ea[0].scrollLeft=a)}function fb(){da=ea[0].scrollTop;ra=ea[0].scrollLeft;var a=Math.abs(da-$a),b=Math.abs(ra-Ac);b&&(Ac=ra,Wa[0].scrollLeft=ra,ob[0].scrollLeft=ra,Aa[0].scrollLeft=ra);if(a)if(ab=$a<da?1:-1,$a=da,a<ba)La(da+ha);else{var c=ha;hb=xa==ba?0:Math.min(ib-1,Math.floor((wa-ba)/(xa-ba)*da*(1/jb)));ha=Math.round(hb*yb);c!=ha&&Qa()}if(b||a)if(Fb&&clearTimeout(Fb),20<
Math.abs(zb-da)||20<Math.abs(pb-ra))d.forceSyncScrolling||Math.abs(zb-da)<ba&&Math.abs(pb-ra)<ma?la():Fb=setTimeout(la,50),w(G.onViewportChanged,{});w(G.onScroll,{scrollLeft:ra,scrollTop:da})}function zc(){for(var a=qa();qb<=rb;){var b=0<=ab?qb++:rb--,c=Q[b];if(c&&!(b>=a)){Ma[b]||(Ma[b]={});nb(b);for(var m in c.b)if(c.b.hasOwnProperty(m)&&(m|=0,a=h[m],a.J&&!Ma[b][m])){var v=c.b[m];v&&a.J(v,b,Ca(b),a);Ma[b][m]=!0}$b=setTimeout(zc,d.asyncPostRenderDelay);break}}}function cc(a,b){var c,m,v;for(v in Q){var x=
b&&b[v];var A=a&&a[v];if(x)for(m in x)A&&x[m]==A[m]||(c=ua(v,pa[m]))&&e(c).removeClass(x[m]);if(A)for(m in A)x&&x[m]==A[m]||(c=ua(v,pa[m]))&&e(c).addClass(A[m])}}function qc(a,b){var c=ta[a];ta[a]=b;cc(b,c);w(G.onCellCssStylesChanged,{key:a,hash:b})}function gd(a){a=e(a.target).closest(".slick-row")[0];a!=Db&&(mb&&mb!=a&&(ja[0].removeChild(mb),mb=null),Db=a)}function ad(a,b){var c=sb(a);if(!c||!dc(c.row,c.cell))return!1;b=w(G.onDragInit,b,a);return a.isImmediatePropagationStopped()?b:!1}function bd(a,
b){var c=sb(a);if(!c||!dc(c.row,c.cell))return!1;b=w(G.onDragStart,b,a);return a.isImmediatePropagationStopped()?b:!1}function cd(a,b){return w(G.onDrag,b,a)}function dd(a,b){w(G.onDragEnd,b,a)}function jc(a){w(G.onKeyDown,{row:M,cell:Z},a);var b=a.isImmediatePropagationStopped();if(!b)if(a.shiftKey||a.altKey||a.ctrlKey)9!=a.which||!a.shiftKey||a.ctrlKey||a.altKey||((c=wb())&&c.length?tb(c[0],!1):b=Jc());else if(27==a.which){if(!C().isActive())return;Bc()}else if(34==a.which)Cc(),b=!0;else if(33==
a.which)Dc(),b=!0;else if(37==a.which)b=Ec();else if(39==a.which)b=Fc();else if(38==a.which)b=Gc();else if(40==a.which)b=Gb();else if(9==a.which){var c=wb();c&&c.length?tb(c[0],!1):b=Hc()}else if(13==a.which){if(d.editable)O?M===qa()?Gb():Ic():C().commitCurrentEdit()&&Hb();else if(b=ec())c=new Slick.EventData,c.target=V,w(G.onFocusTrigger,{row:b.row,cell:b.cell},c);b=!0}if(b){a.stopPropagation();a.preventDefault();try{a.originalEvent.keyCode=0}catch(m){}}}function Yc(a){O||(a.target!=document.activeElement||
e(a.target).hasClass("slick-cell"))&&Ua();var b=sb(a);!b||null!==O&&M==b.row&&Z==b.cell||(w(G.onClick,{row:b.row,cell:b.cell},a),a.isImmediatePropagationStopped()||Z==b.cell&&M==b.row||!Ea(b.row,b.cell)||C().isActive()&&!C().commitCurrentEdit()||(tb(b.row,!1),Va(ua(b.row,b.cell))))}function $c(a){var b=e(a.target).closest(".slick-cell",ja);0===b.length||V===b[0]&&null!==O||w(G.onContextMenu,{},a)}function Zc(a){var b=sb(a);!b||null!==O&&M==b.row&&Z==b.cell||(w(G.onDblClick,{row:b.row,cell:b.cell},
a),a.isImmediatePropagationStopped()||d.editable&&Kc(b.row,b.cell,!0))}function Vc(a){w(G.onHeaderMouseEnter,{column:e(this).data("column")},a)}function Wc(a){w(G.onHeaderMouseLeave,{column:e(this).data("column")},a)}function Tc(a){var b=e(a.target).closest(".slick-header-column",".slick-header-columns");b=b&&b.data("column");w(G.onHeaderContextMenu,{column:b},a)}function Uc(a){var b=e(a.target).closest(".slick-header-column",".slick-header-columns");(b=b&&b.data("column"))&&w(G.onHeaderClick,{column:b},
a)}function ed(a){w(G.onMouseEnter,{},a)}function fd(a){w(G.onMouseLeave,{},a)}function dc(a,b){return!(0>a||a>=qa()||0>b||b>=h.length)}function fc(a){var b=/l\d+/.exec(a.className);if(!b)throw"getCellFromNode: cannot get cell - "+a.className;return parseInt(b[0].substr(1,b[0].length-1),10)}function gc(a){for(var b in Q)if(Q[b].f===a)return b|0;return null}function sb(a){var b=e(a.target).closest(".slick-cell",ja);if(!b.length)return null;a=gc(b[0].parentNode);b=fc(b[0]);return null==a||null==b?null:
{row:a,cell:b}}function lb(){Va(null,!1)}function Ua(){-1==Lc?ub[0].focus():Pb[0].focus()}function Ib(a,b,c){tb(a,c);c=cb(a,b);a=Ya[b];b=Za[b+(1<c?c-1:0)];c=ra+ma;a<ra?(ea.scrollLeft(a),fb(),la()):b>c&&(ea.scrollLeft(Math.min(a,b-ea[0].clientWidth)),fb(),la())}function Va(a,b){null!==V&&(Da(),e(V).removeClass("active"),Q[M]&&e(Q[M].f).removeClass("active"));var c=V!==a;V=a;null!=V?(M=gc(V.parentNode),Z=db=fc(V),null==b&&(b=M==qa()||d.autoEdit),e(V).addClass("active"),e(Q[M].f).addClass("active"),
d.editable&&b&&Mc(M,Z)&&(clearTimeout(hc),d.asyncEditorLoading?hc=setTimeout(function(){Hb()},d.asyncEditorLoadDelay):Hb())):M=Z=null;c&&w(G.onActiveCellChanged,ec())}function Mc(a,b){var c=qa();return a<c&&!Ca(a)||h[b].ea&&a>=c||!sc(a,b)?!1:!0}function Da(){if(O){w(G.S,{editor:O});O.destroy();O=null;if(V){var a=Ca(M);e(V).removeClass("editable invalid");if(a){var b=h[Z],c=Ab(M,b);V.innerHTML=c(M,Z,Bb(a,b),b,a);Yb(M)}}if(navigator.userAgent.toLowerCase().match(/msie/))if(document.selection&&document.selection.empty)try{document.selection.empty()}catch(m){}else window.getSelection&&
(a=window.getSelection())&&a.removeAllRanges&&a.removeAllRanges();C().deactivate(Jb)}}function Hb(a){if(V){if(!d.editable)throw"Grid : makeActiveCellEditable : should never get called when options.editable is false";clearTimeout(hc);if(Mc(M,Z)){var b=h[Z],c=Ca(M);!1===w(G.onBeforeEditCell,{row:M,cell:Z,item:c,column:b})?Ua():(C().activate(Jb),e(V).addClass("editable"),a||(V.innerHTML=""),O=new (a||sc(M,Z))({grid:G,ja:Kb(aa[0]),position:Kb(V),j:V,column:b,item:c||{},L:Ic,K:Bc}),c&&O.i(c),Nc=O.g(),
O.position&&lc())}}}function Ic(){C().commitCurrentEdit()&&(Ua(),d.autoEdit&&Gb())}function Bc(){C().cancelCurrentEdit()&&Ua()}function Kb(a){var b={top:a.offsetTop,left:a.offsetLeft,bottom:0,right:0,width:e(a).outerWidth(),height:e(a).outerHeight(),visible:!0};b.bottom=b.top+b.height;b.right=b.left+b.width;for(var c=a.offsetParent;(a=a.parentNode)!=document.body;)b.visible&&a.scrollHeight!=a.offsetHeight&&"visible"!=e(a).css("overflowY")&&(b.visible=b.bottom>a.scrollTop&&b.top<a.scrollTop+a.clientHeight),
b.visible&&a.scrollWidth!=a.offsetWidth&&"visible"!=e(a).css("overflowX")&&(b.visible=b.right>a.scrollLeft&&b.left<a.scrollLeft+a.clientWidth),b.left-=a.scrollLeft,b.top-=a.scrollTop,a===c&&(b.left+=a.offsetLeft,b.top+=a.offsetTop,c=a.offsetParent),b.bottom=b.top+b.height,b.right=b.left+b.width;return b}function Oc(){return Kb(V)}function lc(){if(V&&(w(G.onActiveCellPositionChanged,{}),O)){var a=Oc();O.show&&O.hide&&(a.visible?O.show():O.hide());O.position&&O.position(a)}}function ec(){return V?{row:M,
cell:Z}:null}function tb(a,b){var c=a*d.rowHeight,m=(a+1)*d.rowHeight-ba+(Qb?f.height:0);(a+1)*d.rowHeight>da+ba+ha?(La(b?c:m),la()):a*d.rowHeight<da+ha&&(La(b?m:c),la())}function Pc(a){a*=Zb;La((xb(da)+a)*d.rowHeight);la();if(d.enableCellNavigation&&null!=M){a=M+a;var b=Ka();a>=b&&(a=b-1);0>a&&(a=0);b=0;for(var c=null,m=db;b<=db;)Ea(a,b)&&(c=b),b+=cb(a,b);null!==c?(Va(ua(a,c)),db=m):lb()}}function Cc(){Pc(1)}function Dc(){Pc(-1)}function cb(a,b){a=n.getItemMetadata&&n.getItemMetadata(a);if(!a||!a.c)return 1;
a=(a=a.c[h[b].id]||a.c[b])&&a.G;"*"===a?a=h.length-b:a=a||1;return a}function Qc(a,b){if(b>=h.length)return null;do b+=cb(a,b);while(b<h.length&&!Ea(a,b));return b<h.length?{row:a,cell:b,s:b}:null}function jd(a,b){if(0>=b)return null;var c;a:{for(c=0;c<h.length;){if(Ea(a,c))break a;c+=cb(a,c)}c=null}if(null===c||c>=b)return null;for(a={row:a,cell:c,s:c};;){c=Qc(a.row,a.cell,a.s);if(!c)return null;if(c.cell>=b)return a;a=c}}function kd(a,b,c){for(var m,v=Ka();;){if(++a>=v)return null;for(m=b=0;b<=
c;)m=b,b+=cb(a,b);if(Ea(a,m))return{row:a,cell:m,s:c}}}function ld(a,b,c){for(var m;;){if(0>--a)return null;for(m=b=0;b<=c;)m=b,b+=cb(a,b);if(Ea(a,m))return{row:a,cell:m,s:c}}}function md(a,b){return null==a&&null==b&&(a=b=0,Ea(a,b))?{row:a,cell:b,s:b}:null}function nd(a,b){return null==a&&null==b&&(a=Ka()-1,b=h.length-1,Ea(a,b))?{row:a,cell:b,s:b}:null}function Fc(){return eb("right")}function Ec(){return eb("left")}function Gb(){return eb("down")}function Gc(){return eb("up")}function Hc(){return eb("next")}
function Jc(){return eb("prev")}function eb(a){if(!d.enableCellNavigation||!V&&"prev"!=a&&"next"!=a)return!1;if(!C().commitCurrentEdit())return!0;Ua();Lc={up:-1,down:1,left:-1,right:1,prev:-1,next:1}[a];if(a=(0,{up:ld,down:kd,left:jd,right:Qc,prev:nd,next:md}[a])(M,Z,db)){var b=a.row==qa();Ib(a.row,a.cell,!b);Va(ua(a.row,a.cell));db=a.s;return!0}Va(ua(M,Z));return!1}function ua(a,b){return Q[a]?(nb(a),Q[a].b[b]):null}function Ea(a,b){return!d.enableCellNavigation||a>=Ka()||0>a||b>=h.length||0>b||
h[b]._noactive?!1:(a=n.getItemMetadata&&n.getItemMetadata(a))&&"boolean"===typeof a.focusable?a.focusable:(a=a&&a.c)&&a[h[b].id]&&"boolean"===typeof a[h[b].id].focusable?a[h[b].id].focusable:a&&a[b]&&"boolean"===typeof a[b].focusable?a[b].focusable:h[b].focusable}function pc(a,b){return a>=qa()||0>a||b>=h.length||0>b?!1:(a=n.getItemMetadata&&n.getItemMetadata(a))&&"boolean"===typeof a.selectable?a.selectable:(a=a&&a.c&&(a.c[h[b].id]||a.c[b]))&&"boolean"===typeof a.selectable?a.selectable:h[b].selectable}
function Kc(a,b,c){za&&Ea(a,b)&&C().commitCurrentEdit()&&(Ib(a,b,!1),b=ua(a,b),Va(b,c||a===qa()||d.autoEdit),O||Ua())}function od(){var a=Ca(M),b=h[Z];if(O){if(O.m()){var c=O.validate();if(c.valid)return M<qa()?(c={row:M,cell:Z,editor:O,X:O.g(),W:Nc,O:function(){this.editor.h(a,this.X);Xb(this.row);w(G.onCellChange,{row:M,cell:Z,item:a})},sa:function(){this.editor.h(a,this.W);Xb(this.row);w(G.onCellChange,{row:M,cell:Z,item:a})}},d.N?(Da(),d.N(a,b,c)):(c.O(),Da())):(c={},O.h(c,O.g()),Da(),w(G.onAddNewRow,
{item:c,column:b})),!C().isActive();e(V).removeClass("invalid");e(V).width();e(V).addClass("invalid");w(G.V,{editor:O,fa:V,ta:c,row:M,cell:Z,column:b});O.focus();return!1}Da()}return!0}function pd(){Da();return!0}function qd(a){for(var b=[],c=h.length-1,m=0;m<a.length;m++)b.push(new Slick.Range(a[m],0,a[m],c));return b}function wb(){if(!ya)throw"Selection model is not set";return Vb}var rd={explicitInitialization:!1,rowHeight:25,defaultColumnWidth:80,enableAddRow:!1,leaveSpaceForNewRows:!1,editable:!1,
...
fullWidthRows:!1,multiColumnSort:!1,defaultFormatter:function(a,b,c){return null==c?"":(c+"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")},forceSyncScrolling:!1,addNewRowCssClass:"new-row"},Wb={name:"",resizable:!0,sortable:!1,minWidth:30,rerenderOnResize:!1,headerCssClass:null,defaultSortAsc:!0,focusable:!0,selectable:!0},wa,xa,jb,ib,yb,hb=0,ha=0,ab=1,za=!1,aa,na="slickgrid_"+Math.round(1E6*Math.random()),G=this,ub,Pb,Wa,ca,Na,Aa,kc,ob,ea,bb,ja,Ra,Oa,Sa,Tb,Ub,ba,ma,Ba,Qb,Ga,Pa=
0,nc=0,Rb=0,Sb=0,Ja,Lc=1,db,M,Z,V=null,O=null,Nc,Jb,Q={},uc=0,Zb,$a=0,da=0,zb=0,pb=0,Ac=0,ra=0,ya,Vb=[],Ia=[],ta={},pa={},oa=[],Ya=[],Za=[],hc=null,Fb=null,$b=null,Ma={},rb=null,qb=null,id=0,hd=0,Db,mb,ac=!1;e.extend(this,{slickGridVersion:"2.1",onScroll:new Slick.Event,onSort:new Slick.Event,onHeaderMouseEnter:new Slick.Event,onHeaderMouseLeave:new Slick.Event,onHeaderContextMenu:new Slick.Event,onHeaderClick:new Slick.Event,I:new Slick.Event,H:new Slick.Event,U:new Slick.Event,T:new Slick.Event,
...
onDragInit:new Slick.Event,onDragStart:new Slick.Event,onDrag:new Slick.Event,onDragEnd:new Slick.Event,onSelectedRowsChanged:new Slick.Event,onCellCssStylesChanged:new Slick.Event,registerPlugin:function(a){Ia.unshift(a);a.init(G)},unregisterPlugin:F,getColumns:function(){return h},setColumns:mc,getColumnIndex:function(a){return pa[a]},updateColumnHeader:function(a,b,c){if(za&&(a=pa[a],null!=a)){var m=h[a],v=ca.children().eq(a);v&&(void 0!==b&&(h[a].name=b),void 0!==c&&(h[a].toolTip=c),w(G.H,{node:v[0],
column:m}),v.attr("title",c||"").children().eq(0).html(b),w(G.I,{node:v[0],column:m}))}},setSortColumn:function(a,b){vb([{columnId:a,sortAsc:b}])},setSortColumns:vb,getSortColumns:function(){return oa},autosizeColumns:fa,getOptions:function(){return d},setOptions:function(a){C().commitCurrentEdit()&&(Da(),d.enableAddRow!==a.enableAddRow&&wc(qa()),d=e.extend(d,a),d.autoHeight&&(d.leaveSpaceForNewRows=!1),ea.css("overflow-y",d.autoHeight?"hidden":"auto"),la())},getData:function(){return n},getDataLength:qa,
getDataItem:Ca,setData:function(a,b){n=a;Qa();Eb();b&&La(0)},getSelectionModel:function(){return ya},setSelectionModel:function(a){ya&&(ya.onSelectedRangesChanged.unsubscribe(oc),ya.destroy&&ya.destroy());if(ya=a)ya.init(G),ya.onSelectedRangesChanged.subscribe(oc)},getSelectedRows:wb,setSelectedRows:function(a){if(!ya)throw"Selection model is not set";ya.setSelectedRanges(qd(a))},getContainerNode:function(){return aa.get(0)},render:la,invalidate:function(){Eb();Qa();la()},invalidateRow:wc,invalidateRows:vc,
invalidateAllRows:Qa,updateCell:function(a,b){var c=ua(a,b);if(c){var m=h[b],v=Ca(a);O&&M===a&&Z===b?O.i(v):(c.innerHTML=v?Ab(a,m)(a,b,Bb(v,m),m,v):"",Yb(a))}},updateRow:Xb,getViewport:kb,getRenderedRange:xc,resizeCanvas:Fa,updateRowCount:Eb,scrollRowIntoView:tb,scrollRowToTop:function(a){La(a*d.rowHeight);la()},scrollCellIntoView:Ib,getCanvasNode:function(){return ja[0]},focus:Ua,getCellFromPoint:function(a,b){b=xb(b);for(var c=0,m=0,v=0;v<h.length&&m<a;v++)m+=h[v].width,c++;0>c&&(c=0);return{row:b,
cell:c-1}},getCellFromEvent:sb,getActiveCell:ec,setActiveCell:function(a,b){!za||a>qa()||0>a||b>=h.length||0>b||!d.enableCellNavigation||(Ib(a,b,!1),Va(ua(a,b),!1))},getActiveCellNode:function(){return V},getActiveCellPosition:Oc,resetActiveCell:lb,editActiveCell:Hb,getCellEditor:function(){return O},getCellNode:ua,getCellNodeBox:function(a,b){if(!dc(a,b))return null;a=d.rowHeight*a-ha;for(var c=a+d.rowHeight-1,m=0,v=0;v<b;v++)m+=h[v].width;return{top:a,left:m,bottom:c,right:m+h[b].width}},canCellBeSelected:pc,
canCellBeActive:Ea,navigatePrev:Jc,navigateNext:Hc,navigateUp:Gc,navigateDown:Gb,navigateLeft:Ec,navigateRight:Fc,navigatePageUp:Dc,navigatePageDown:Cc,gotoCell:Kc,getInnerTopPanel:function(){return bb[0]},setInnerTopPanelVisibility:function(a){d.showInnerTopPanel!=a&&((d.showInnerTopPanel=a)?bb.slideDown("fast",Fa):bb.slideUp("fast",Fa))},setHeaderRowVisibility:function(a){d.showHeaderRow!=a&&((d.showHeaderRow=a)?Aa.slideDown("fast",Fa):Aa.slideUp("fast",Fa))},getHeaderRow:function(){return Na[0]},
getHeaderRowColumn:function(a){a=pa[a];return(a=Na.children().eq(a))&&a[0]},getGridPosition:function(){return Kb(aa[0])},flashCell:function(a,b,c){function m(x){x&&setTimeout(function(){v.queue(function(){v.toggleClass(d.cellFlashingCssClass).dequeue();m(x-1)})},c)}c=c||100;if(Q[a]){var v=e(ua(a,b));m(4)}},addCellCssStyles:function(a,b){if(ta[a])throw"addCellCssStyles: cell CSS hash with key '"+a+"' already exists.";ta[a]=b;cc(b,null);w(G.onCellCssStylesChanged,{key:a,hash:b})},setCellCssStyles:qc,
...
b={width:a.width()-a[0].clientWidth,height:a.height()-a[0].clientHeight},a.remove(),a=b);f=a;d=e.extend({},rd,d);d.autoHeight&&(d.leaveSpaceForNewRows=!1);Wb.width=d.defaultColumnWidth;pa={};for(a=0;a<h.length;a++)b=h[a]=e.extend({},Wb,h[a]),pa[b.id]=a,b.minWidth&&b.width<b.minWidth&&(b.width=b.minWidth),b.maxWidth&&b.width>b.maxWidth&&(b.width=b.maxWidth);if(d.enableColumnReorder&&!e.fn.sortable)throw Error("SlickGrid's 'enableColumnReorder = true' option requires jquery-ui.sortable module to be loaded");
Jb={commitCurrentEdit:od,cancelCurrentEdit:pd};aa.empty().css("overflow","hidden").css("outline",0).addClass(na).addClass("ui-widget");/relative|absolute|fixed/.test(aa.css("position"))||aa.css("position","relative");ub=e("<div tabIndex='0' hideFocus style='position:fixed;width:0;height:0;top:0;left:0;outline:0;'></div>").appendTo(aa);Wa=e("<div class='slick-header ui-state-default' style='overflow:hidden;position:relative;' />").appendTo(aa);ca=e("<div class='slick-header-columns' style='left:-1000px' />").appendTo(Wa);
ca.width(S());Aa=e("<div class='slick-headerrow ui-state-default' style='overflow:hidden;position:relative;' />").appendTo(aa);Na=e("<div class='slick-headerrow-columns' />").appendTo(Aa);kc=e("<div style='display:block;height:1px;position:absolute;top:0;left:0;'></div>").css("width",T()+f.width+"px").appendTo(Aa);ob=e("<div class='slick-top-panel-scroller ui-state-default' style='overflow:hidden;position:relative;' />").appendTo(aa);e("<div class='slick-top-panel' style='width:10000px' />").appendTo(ob);
...
parseInt(h.max))h.value=h.max;else if(h.min)h.value=h.min;else return;e(h).change()}var q=e.data(this,"numeric.decimal"),r=e.data(this,"numeric.callback"),n=this.value;""!==n?(new RegExp("^\\d+$|^\\d*"+q+"\\d+$")).exec(n)&&this.validity.valid||(f(this),r.apply(this)):(f(this),r.apply(this))};e.fn.ma=function(){return this.data("numeric.decimal",null).data("numeric.negative",null).data("numeric.callback",null).unbind("keypress",e.fn.numeric.keypress).unbind("blur",e.fn.numeric.blur)}})(jQuery);var sa=`https://chrome.google.com/webstore/detail/chrono-download-manager/${chrome.runtime.id}`,va=sa+"/reviews";window.dataLayer=window.dataLayer||[];function Lb(){window.dataLayer.push(arguments)}Lb("js",new Date);var Mb=chrome.runtime.getManifest().version;Lb("config","UA-32450437-5",{allow_google_signals:!1,anonymize_ip:!0,custom_map:{dimension1:"extVersion"}});const Nb={ss:300,dz:250,fe_us:150,sf:150,sets:100,stats:50},ic={dz:.3,fe_us:.22,sf:.006,sets:.01,stats:.01},Rc={sets:5,stats:5},Sc={sets:{F:0,D:0},stats:{F:0,D:0}};
function sd(e,f,q){var r=Rc.sets;if(r){var n=Sc.sets;if(n){var h=Date.now();864E5<h-(n.D||0)&&(n.D=h,n.F=0);n.F++>=r||(e=["_trackEvent","sets",e,f,q,void 0],r&&(f=ic[e[1]]||1,(q=Nb[e[1]])&&Math.floor(5E3*Math.random()*r*f)<q&&(e[1]+=`[${q}][1:${5}]`,e[2]+=`[1:${r}:${f}]`,r={event_category:e[1],extVersion:Mb},e[3]&&(r.event_label=e[3]),e[4]&&(r.value=e[4]),e[5]&&(r.non_interaction=!0),Lb("event",e[2],r))))}}}
window.addEventListener("load",function(){var e=document.createElement("script");e.type="text/javascript";e.async=!0;e.src="https://www.googletagmanager.com/gtag/js?id=UA-32450437-5";document.body.appendChild(e)});var td=localStorage;function ud(){function e(f,q){f="i18n-"+f;for(var r=document.querySelectorAll("["+f+"]"),n=0;n<r.length;++n){var h=Y(r[n].attributes[f].value);r[n][q]=h;r[n].removeAttribute(f)}}e("text","innerText");e("title","title");e("href","href");e("placeholder","placeholder");(function(f,q){f="i18n-"+f;for(var r=document.querySelectorAll("["+f+"]"),n=0;n<r.length;++n){var h=Y(r[n].attributes[f].value);r[n].setAttribute(q,h);r[n].removeAttribute(f)}})("tooltip","data-tooltip");(function(f,q){f="i18n-"+f;for(var r=
document.querySelectorAll("["+f+"]"),n=0;n<r.length;++n){var h=r[n].attributes[f].value.split(","),d=h[0];h.shift();h=Y(d,h);r[n][q]=h;r[n].removeAttribute(f)}})("textparams","innerText");"undefined"!=typeof vd&&wd()}
function wd(){var e=vd.get("font_size");document.documentElement.classList.contains("fs-none")||(document.documentElement.style.fontSize&&document.documentElement.classList.remove("fs-"+document.documentElement.style.fontSize),document.documentElement.style.fontSize=e+"px",document.documentElement.classList.add("fs-"+e+"px"))};function xd(){document.oncontextmenu=function(e){var f=e.target.nodeName.toLowerCase(),q=e.target.type&&e.target.type.toLowerCase();if(!e.target.classList.contains("allow-ctx-menu")&&(e.target.disabled||"textarea"!=f&&("input"!=f||"text"!=q&&"number"!=q)))return!1}};const yd=["",[String.fromCharCode(103),String.fromCharCode(108),String.fromCharCode(99)].join(""),"1_"].join("_");function zd(){var e=void 0;var f=td[yd+"fe_us"];if(void 0!=f)try{e=JSON.parse(atob(f[1]+f.substr(3)))}catch(q){}f=Date.now();return!e||!e._t||isNaN(e._t)||!isFinite(e._t)||6048E5<f-e._t?{_t:f}:e}
function Ad(){var e=e||1;var f=zd(),q=function(r){return btoa(r.split("").map(n=>{var h=n.charCodeAt(0),d=0;"_"!=n&&(d=60<h?-55:53);return String.fromCharCode(h+d)}).join(""))}("help")+"";f[q]=(f[q]||0)+e;(function(r,n){n=btoa(JSON.stringify(n));td[yd+r]=String.fromCharCode(97+Math.floor(26*Math.random()))+n[0]+String.fromCharCode(97+Math.floor(26*Math.random()))+n.substr(1)})("fe_us",f)};function Bd(){var e=$(".share_buttons");function f(r,n,h,d,y,F){F?$.get(F,function(){f(h,d,y)}):$.get(h,function(){r.find("."+n).html('<iframe allowTransparency="true" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:'+d+"px; height:"+y+'px;" src="'+h+'"></iframe>')}).error(function(){})}var q='<span style="padding-right:18px">\t\t\t<a href="'+va+'" target="_blank">\t\t\t<img style="vertical-align:bottom" width=21 height=21 alt="Rate" src="../icons/cws.png"/>\t\t\t<span>'+
...
sa)}&flair_text=Extension`;document.querySelector(".rd_span").innerHTML=`<a target=_blank href='${r}'><img src='../icons/reddit.png' height=21/></a>`}})};var Y=chrome.i18n.getMessage,Cd=chrome.extension.getBackgroundPage(),Dd=Cd.dy_bkg,vd=Cd.dy_settings,Ed=Cd.dy_rules;
$(function(){$("#help_holder").load(Y("helpFile"),function(){$("#about_holder").load(Y("aboutFile"),function(){function e(u,z){var N=vd.getCat(u),K=N.name;z=$("#dy_"+u+" "+(z||".content"));$("#dy_"+u+" header").html("<h1>"+K+"</h1>");$(".menu a[href=#"+u+"]").text(K);u="";K=[];for(var R=0,U=N.sections.length;R<U;++R){var B=N.sections[R];u+="<section"+(B.id?' id="'+B.id+'">':">");B.name&&(u+="<h3>"+B.name,B.tip&&(u+='<span class="simptip-position-top" data-tooltip="'+B.tip+'"></span>'),u+="</h3>");
B.description&&(u+="<div>"+B.description+"</div>");for(var D=0,H=B.items.length;D<H;++D){var w=B.items[D],C=vd.getRaw(w);if(!C.native_only){var fa="";C.tip&&(fa=C.tipURL?'<a class="simptip-position-top" data-tooltip="'+C.tip+'" target=_blank href="'+C.tipURL+'"></a>':'<span class="simptip-position-top" data-tooltip="'+C.tip+'"></span>');switch(C.type){case "button":fa="<button"+(C.onclick?' id="optbtn_'+w+'"':"")+">"+C.buttonText+"</button>";u+="<div>"+(C.label?'<label>\t\t\t\t\t\t\t\t<span class="field_label">'+
...
field:"condition",editor:Slick.Editors.Text,sortable:!1,behavior:"selectAndMove",width:220},{id:h++,name:Y("fieldNaming"),field:"naming",editor:Slick.Editors.Text,sortable:!1,behavior:"selectAndMove",width:110}];window.unload=function(){vd.commit();Cd.console.log("settings changes saved")};xd();ud();(function(){$(".menu a").click(function(u){$(".section-highlighted").removeClass("section-highlighted");$(".mainview > *").removeClass("selected");$(".menu li").removeClass("selected");setTimeout(function(){$(".mainview > *:not(.selected)").css("display",
"none")},100);$(u.currentTarget).parent().addClass("selected");u=($(u.currentTarget).attr("href")||"#").replace("#","#dy_");"#dy_about"==u&&0==$(".share_buttons").children().length&&($("#version-number").text(chrome.runtime.getManifest().version),Bd());var z=$(u);z.css("display","block");setTimeout(function(){z.addClass("selected")},0);setTimeout(function(){$("body")[0].scrollTop=0},200);vd.commit()})})();e("general");e("interface");e("rules");$("#dy_panic_reset").click(function(){confirm(Y("confirmReset"))&&
($("#dy_panic_reset").prop("disabled",!0),Dd.reset())});(function(){for(var u in vd.items){var z=vd.items[u],N=$("#"+u);switch(z.type){case "bool":N.attr("checked",z.value);N.change(function(){vd.set(this.id,this.checked);sd(this.id,""+this.checked)});break;case "string":N.val(z.value);N.change(function(){var K=(this.value||"").trim();vd.set(this.id,K);sd(this.id,K);K!=this.value&&(this.value=K)});break;case "int":N.val(z.value);N.change(function(){var K=parseInt(this.value);vd.set(this.id,K)&&sd(this.id,
"",K)});break;case "select":Array.isArray(z.options[0])?N.val(z.value):N.val(z.options[z.value]),N.change(function(){var K=parseInt(this.value);if(isNaN(K)||!isFinite(K))K=parseInt(this.selectedIndex);vd.set(this.id,K);sd(this.id,""+K)})}}})();$("input[type=number]").numeric({decimal:!1,negative:!1});$("#dy_opendy").click(function(){chrome.runtime.sendMessage({cmd:"open_ui"},function(u){u&&window.close()})});var y=Y("translateContributors");y?$("#translation_info").html("This "+Y("uilangName")+" language version is translated by "+
...
$(".simpletable tbody").hide();$(".simpletable thead").click(function(){$(this).next().toggle()});var F=Ed.getLinkFilters(),S=Ed.getRules();var T=new Slick.Grid("#cats_grid",F,d,{enableColumnReorder:!0,enableAddRow:!0,editable:!0,autoEdit:!1});T.registerPlugin(new Slick.AutoTooltips({enableForHeaderCells:!0,enableForCells:!0,maxToolTipLength:256}));var I=new Slick.Grid("#rules_grid",S,h,{enableColumnReorder:!0,enableAddRow:!0,editable:!0,autoEdit:!1});I.registerPlugin(new Slick.AutoTooltips({enableForHeaderCells:!0,
enableForCells:!0,maxToolTipLength:256}));q(T,F,Ed.on_filters_change);q(I,S,Ed.on_rules_change);$("#cats_grid").on("blur","input",function(){setTimeout(function(){var u=T.getEditorLock();u.isActive()&&0==$("#cats_grid :focus").length&&u.commitCurrentEdit()})});$("#rules_grid").on("blur","input",function(){setTimeout(function(){var u=I.getEditorLock();u.isActive()&&0==$("#rules_grid :focus").length&&u.commitCurrentEdit()})});T.onCellChange.subscribe(Ed.on_filters_change);I.onCellChange.subscribe(Ed.on_rules_change);
T.onAddNewRow.subscribe(function(u,z){Ed.addFilter(z.item);T.updateRowCount();T.invalidateRow(F.length-1);T.render()});T.onKeyDown.subscribe(function(u){var z=T.getSelectedRows().slice(0);if(46==u.keyCode&&!T.getEditorLock().isActive()&&0<z.length&&confirm(Y("confirmRemoveExtFilter"))){z.sort(r);for(u=0;u<z.length;++u)F.splice(z[u],1);Ed.on_filters_change();T.setSelectedRows([]);T.invalidate()}});I.onAddNewRow.subscribe(function(u,z){Ed.addRule(z.item);I.updateRowCount();I.invalidateRow(S.length-
1);I.render()});I.onKeyDown.subscribe(function(u){var z=I.getSelectedRows().slice(0);if(46==u.keyCode&&!I.getEditorLock().isActive()&&0<z.length&&confirm(Y("confirmRemoveRule"))){z.sort(r);for(u=0;u<z.length;++u)S.splice(z[u],1);Ed.on_rules_change();I.setSelectedRows([]);I.invalidate()}});T.onSort.subscribe(function(u,z){var N=z.sortCol.field,K=z.sortAsc;F.sort(function(R,U){R=R[N]<U[N]?-1:1;return K?R:-R});Ed.on_filters_change();T.invalidateAllRows();T.render()});I.onSort.subscribe(function(u,z){var N=
z.sortCol.field,K=z.sortAsc;S.sort(function(R,U){R=R[N]<U[N]?-1:1;return K?R:-R});Ed.on_rules_change();I.invalidateAllRows();I.render()});T.enableColumnFit();I.enableColumnFit();window.onhashchange=n;n()})})});
